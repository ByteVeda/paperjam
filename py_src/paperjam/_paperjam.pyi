...
class ConversionError(PaperJamError): ...
class FormatError(PaperJamError): ...
class PipelineError(PaperJamError): ...
...
class RustAnyDocument:
    @staticmethod
    def open(path: str, format: str | None = None) -> RustAnyDocument: ...
    @staticmethod
    def from_bytes(data: bytes, format: str) -> RustAnyDocument: ...
    ...
    def convert_to(self, target_format: str) -> bytes: ...
...
def convert_bytes(data: bytes, from_format: str, to_format: str) -> bytes: ...
def detect_format(path: str) -> str: ...

# --- Pipeline functions ---

def run_pipeline(yaml: str) -> dict[str, Any]: ...
def validate_pipeline(yaml: str) -> None: ...
